...
/**
 * Wraps a Swift `(_ locations: [Location]) -> Void` as a class.
...
public final class Func_void_std__vector_Location_ {
  ...
  private let closure: (_ locations: [Location]) -> Void

  public init(_ closure: @escaping (_ locations: [Location]) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(locations: bridge.std__vector_Location_) -> Void {
